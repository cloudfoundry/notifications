...
var _ = Describe("Router", func() {
	...
	It("routes PUT /clients/{clientID}/notifications/{notificationID}", func() {
		s := router.Routes().Get("PUT /clients/{clientID}/notifications/{notificationID}").GetHandler().(stack.Stack)
