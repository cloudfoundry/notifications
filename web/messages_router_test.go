...
var _ = Describe("MessagesRouter", func() {
	...
	BeforeEach(func() {
		router = web.NewMessagesRouter(fakes.NewMessageFinder(), fakes.NewErrorWriter(), middleware.RequestLogging{}, middleware.Authenticator{Scopes: []string{"notifications.write", "emails.write"}}, middleware.DatabaseAllocator{})
	})
