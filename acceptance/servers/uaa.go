...
var UAAPostOAuthToken = http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
	...
	case "client_credentials":
		token.Claims["scope"] = []string{"notifications.manage", "notifications.write", "emails.write", "notification_preferences.admin", "critical_notifications.write", "notification_templates.admin"}
